...
## Dónde vive
- Código: `src/components/C5Dashboard.tsx` — función/componente `IAView()`, líneas 781-1011
...
- Las barras de "Eficacia del Sistema" (líneas 987-1012) son porcentajes fijos, no una medición real.
