...
## Dónde vive
- Código: `src/components/C5Dashboard.tsx` — función/componente `GabineteView()`, líneas 1529-1640


## Cómo editarlo
- Los 4 funcionarios y sus KPIs/tiempos de respuesta/proyectos (líneas 1550-1595) son un arreglo hardcodeado con nombres reales.
